...
export function PerformanceView({
  ...
  const metricCards = hasData
    ? [
        ...
        { label: "Duels ouverts", value: `${metrics.openingDuelSuccess.toFixed(1)}%`, sub: "réussite", color: "text-ai-purple" as const, tooltip: "Pourcentage de duels d'ouverture gagnés" },
