...
export function AiInsightsPanel({ insights }: AiInsightsPanelProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-900/30 to-purple-900/20 border border-indigo-500/30 rounded-2xl p-6">
      ...
      {insights.summary && (
        <div className="bg-[#111115]/60 backdrop-blur-sm border border-slate-700/50 rounded-xl p-4 mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {insights.strengths.length > 0 && (
          <div className="bg-[#111115]/40 border border-emerald-500/20 rounded-xl p-4">
        ...
        {insights.weaknesses.length > 0 && (
          <div className="bg-[#111115]/40 border border-rose-500/20 rounded-xl p-4">
            <h4 className="text-xs font-bold text-rose-400 uppercase tracking-wider mb-3">Axes d&apos;amélioration</h4>
            <ul className="space-y-2">
